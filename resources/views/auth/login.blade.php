        ...
        <div class="row align-items-center row-login">
          ...
          <div class="col-lg-5">
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-3">
              ...
              <button type="submit" class="btn btn-success btn-block w-75 mt-4" href="/login.html"> Sign In to My Account</button>
              <a class="btn btn-signup w-75 mt-2" href="{{ route('register') }}">Sign Up</a>
            </form>
          </div>
        </div>
      </div>
