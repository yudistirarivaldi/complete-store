    ...
    @section('content')
    <div class="section-content section-dashboard-home" ata-aos="fade-up">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="name" value="Papel la casa " value="{{ $product->name }}" class="form-control" aria-describedby="storeHelp"/>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Price</label>
                            <input type="number" name="price" value="200" value="{{ $product->price }}"  class="form-control" aria-describedby="storeHelp"/>
                          </div>
                        </div>
    ...
    <script>function thisFileUpload() {
